...
POLICY_MATRIX: dict[str, dict[str, Any]] = {
    "lab": {
        ...
        "operator_notes": [
            "Use for isolated validation, controlled simulation, and response workflow testing.",
    ...
    "corp": {
        ...
        "operator_notes": [
            ...
            "Keep remote-impact testing inside approved team workspaces only.",
        ],
    },
    "prod": {
        "dangerous_actions": False,
...
def build_policy_matrix() -> dict[str, Any]:
    return {
        ...
        "recommendations": [
            "Use lab for safe adversary simulation and response workflow testing.",
